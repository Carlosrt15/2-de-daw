...
public class InsertarFaltaController extends HttpServlet {
    ...
    public InsertarFaltaController() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher d = getServletContext()
                .getRequestDispatcher("/WEB-INF/vistas/faltas/insertarFalta.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int resultado = service.insertarFalta(id, alumno, asignatura, fecha, justificada);
