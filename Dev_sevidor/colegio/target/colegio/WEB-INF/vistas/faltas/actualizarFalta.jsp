...
<div class="form">
    ...
    <form action="/colegio/faltas/actualizarFalta" method="post">

        <input type="hidden" name="idfaltas" value="${falta.idfaltas}">

        <label>Alumno:</label>
        <input type="number" name="alumno" value="${falta.alumno}" required>

        <label>Asignatura:</label>
        <input type="number" name="asignatura" value="${falta.asignatura}" required>

        <label>Fecha:</label>
        <input type="date" name="fecha" value="${falta.fecha}" required>
