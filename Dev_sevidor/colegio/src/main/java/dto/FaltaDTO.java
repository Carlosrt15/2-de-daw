...
public class FaltaDTO {
    ...
    // -------------------------------------------------
    public FaltaDTO(int idFalta, int idAlumno, String nombreAlumno,
                    int idAsignatura, String nombreAsignatura,
    ...
    // -------------------------------------------------
    public FaltaDTO(String idFalta, String idAlumno, String idAsignatura,
                    String fecha, int justificada) {
        this.idFalta = Integer.parseInt(idFalta);
        this.idAlumno = Integer.parseInt(idAlumno);
        this.idAsignatura = Integer.parseInt(idAsignatura);
        this.fecha = fecha;
        this.justificada = justificada;
    }
